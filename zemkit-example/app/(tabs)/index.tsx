...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, Button } from 'zemkit-ui';
...
export default function TabOneScreen() {
  return (
    <View className="flex-1 justify-center items-center p-6">
      ...
      <Button className="mt-5" variant={'destructive'} onPress={() => console.log('asfaf')}>
        <Text>Test</Text>
      </Button>
    </View>
  );
